...
Add sources that expose regulatory and procurement content currently unavailable through the public web dashboard. Planned across two sequential workstreams — see [`docs/plans/m5-new-source-types.md`](plans/m5-new-source-types.md) for the plan, live-triage findings, and status.
...
**Status:** Not started — designed 2026-09-17 (both candidate sources live-verified per the M4a/M4b discipline); see the plan doc for the M5a/M5b split.
