  ...
  return (
    <div className="rounded border border-neutral-800 p-4">
      <div className="mb-3 flex items-baseline justify-between gap-2">
        ...
        <span className={`text-xs ${RUN_STATUS_COLOR[targetFile.run.status]}`}>
          {RUN_STATUS_LABEL[targetFile.run.status]}
        </span>
      </div>
